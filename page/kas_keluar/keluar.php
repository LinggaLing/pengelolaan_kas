                                ...
                                ?>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="?page=keluar&aksi=hapus&id=<?php echo $data['kode'];?>" class="btn btn-danger btn-md" title="Hapus Data"><i class="fa fa-trash"> </i></a>
                                            </td>
                                        </tr>
                                        <?php 
                                ...
                                <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" id="modal_edit">
                                                <form role="form" method="POST">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input class="form-control" name="Nama" placeholder="<? $data['nama']?>" id="nama" readonly />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <select id="status" name="status">
															<option id="Sudah Selesai">Sudah Selesai"</option>
															<option id="Belum Selesai">Belum Selesai"</option>
														</select>
                                                    </div>
                                            </div>
                                            <div class="modal-footer">
                                        ...
                                        if(isset($_POST['ubah'])) {
                                            ...
                                            $sql = mysqli_query($koneksi, "UPDATE tb_pasien SET status = '$status' WHERE nama = '$nama' ");
                                            if($sql) {
                                                echo "
                                                    <script>
